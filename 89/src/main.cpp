...
vex::motor RightDriveF(PORT19,false); 
vex::motor RightDriveR(PORT20,false);
vex::motor LeftDriveF(PORT11,true);
vex::motor LeftDriveR(PORT12,true); 
...
//    int  StrafeX = Controller.Axis1.position();
    ...
    //Arm.setVelocity(StrafeY, percentUnits::pct);
   /* if(StrafeY ==0)
    {
      Arm.stop();
